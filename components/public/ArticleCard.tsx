  ...
  return (
    <article className="overflow-hidden rounded-[26px] border border-[#e8dfc8] bg-white shadow-[0_14px_48px_rgba(31,59,47,0.1)] transition hover:-translate-y-1 hover:shadow-[0_18px_55px_rgba(31,59,47,0.14)]">
      ...
      <div className="space-y-3 p-5">
        ...
        <Link href={`/guides/${article.slug}`} className="inline-flex rounded-full bg-(--color-forest-green) px-4 py-2 text-sm font-semibold text-(--color-cream) transition hover:bg-(--color-pine)">
          Read guide
        </Link>
      </div>
    </article>
